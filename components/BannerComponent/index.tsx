...
const BannerComponent = ({ title, subtitle, description,img }) => {
  return (
    <div className="relative h-[150px] w-full bg-cover bg-center text-white mb-5 !rounded-md shadow-md" style={{ backgroundImage: `url(${img})` ,backgroundPosition:"center",
        backgroundRepeat:'no-repeat',backgroundSize:"contain"
    }}>
      {/* <img src={img} className="h-[300px] w-full" alt="banner-img" /> */}
